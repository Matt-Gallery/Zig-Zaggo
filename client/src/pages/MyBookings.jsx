...
const MyBookings = () => {
  ...
  const fetchUserBookings = async () => {
    try {
      const response = await authService.fetchWithAuth('/booking/my-bookings');
      if (!response.ok) {
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      const response = await authService.fetchWithAuth(`/booking/cancel/${selectedBookingId}`, {
        method: 'POST'
      });
      ...
      <div className="container">
        ...
        {bookings.length > 0 ? (
          ...
          <div className="search-results-empty">
            ...
            <Link to="/search" className="btn btn-primary">Search for Flights</Link>
          </div>
        )}
